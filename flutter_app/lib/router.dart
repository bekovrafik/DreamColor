...
GoRouter createRouter(AppProvider appProvider) {
  return GoRouter(
    ...
    redirect: (context, state) {
      ...
      if (!isAuthenticated) {
        // If not authenticated, they can only be on login/register/onboarding
        return isLoggingIn ? null : '/';
      }

      // If authenticated and on a public page, go home
      if (isLoggingIn) {
        return '/home';
      }
    ...
    routes: [
      ...
      GoRoute(
        ...
        builder: (context, state) =>
            const BillingScreen(), // Point both to same screen
      ),
